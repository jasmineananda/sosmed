  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand d-flex align-items-center m-0" href=" https://demos.creative-tim.com/corporate-ui-dashboard/pages/dashboard.html " target="_blank">
        <span class="font-weight-bold text-lg">Sosmed</span>
      </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 " href="../pages/sign-in.php">
        ...
        <div class="col-md-12">
          <div class="d-md-flex align-items-center mb-3 mx-2">
            <div class="mb-md-0 mb-3">
              ...
              <p class="mb-0">Trending Content</p>
            </div>
        ...
        <div class="col-lg-12">
          <div class="card shadow-xs border">
            <div class="card-header pb-0">          
              <form name="form_posting" method="post" action="proses_posting.php" enctype="multipart/form-data">  
                <div class="ms-auto d-flex">                  
                  <div class="input-group input-group-md md-auto me-2">
                    <input type="text" name="txt_word" class="form-control form-control-sm" placeholder="Word for today">
                  </div>
                  <div class="input-group input-group-sm ms-auto me-2">
                    <input type="file" name="file_foto" class="form-control form-control-sm" placeholder="Search">
                  </div>
                  <input type="submit" name="submit_post" value="POST" class="btn btn-sm btn-dark btn-icon d-flex align-items-center mb-0 me-2"></input>
                </div>
              </form>
              <br>
            </div>
        ...
        <div class="col-lg-12">
          <div class="card shadow-xs border">
            <div class="card-header pb-0">
              ...
              <?php
                    $query = "SELECT * FROM t_postingan ORDER BY id_p DESC";
                    $result = mysqli_query($koneksikan, $query);
                    if(!$result){
                      die ("Query Error: ".mysqli_errno($koneksikan).
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <div class="text-center mt-2">
                            <img src="foto/<?php echo $row['foto']; ?>" class="img-fluid rounded" alt="Responsive image">
                        </div>
                        <div class="d-flex justify-content-between align-items-center mt-2">
                            ...
                            <small class="text-muted"><?php echo $row['tgl_post']; ?></small>
                        </div>
                    </div>
                </div>
